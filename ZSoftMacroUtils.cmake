...
MACRO(ZS_SETUP_TARGET_CONFIG_LINK_FLAGS _ZS_TARGET_NAME _TARGET_TYPE)
    ...
    FOREACH(_ZS_ITEM ${ZS_GLOBAL_LINK_FLAGS})
        SET(_ZS_LINK_FLAGS "${_ZS_LINK_FLAGS}${_ZS_ITEM} ")
    ENDFOREACH()
    
    FOREACH(_ZS_ITEM ${ZS_${_TAGET_TYPE}_GENERAL_LINK_FLAGS})
        SET(_ZS_LINK_FLAGS "${_ZS_LINK_FLAGS}${_ZS_ITEM} ")
    ENDFOREACH()
	...
	FOREACH(_ZS_CONF ${ZS_GLOBAL_CONFIGUATION_TYPES})
		STRING(TOUPPER ${_ZS_CONF} _ZS_CONF)
        SET(_ZS_LINK_FLAGS_${_ZS_CONF})
        
        FOREACH(_ZS_ITEM ${ZS_GLOBAL_LINK_FLAGS_${_ZS_CONF}})
            SET(_ZS_LINK_FLAGS_${_ZS_CONF} "${_ZS_LINK_FLAGS_${_ZS_CONF}}${_ZS_ITEM} ")
        ENDFOREACH()
        
        FOREACH(_ZS_ITEM ${ZS_${_TARGET_TYPE}_LINK_FLAGS_${_ZS_CONF}})
            SET(_ZS_LINK_FLAGS_${_ZS_CONF} "${_ZS_LINK_FLAGS_${_ZS_CONF}}${_ZS_ITEM} ")
        ENDFOREACH()
...
MACRO(ZS_SETUP_APPLICATION)
	IF(ZS_APPLICATION_MOC_SRCS)
        INCLUDE_DIRECTORIES(
            ${ZS_QT_ROOT}/include
            ${ZS_APPLICATION_MOC_INCLUDE_DIRECTORIES}
        )
    ...
    IF(NOT ZS_APPLICATION_CUSTOM_GROUP)
	...
	TARGET_INCLUDE_DIRECTORIES(${ZS_APPLICATION_NAME} PUBLIC
		${ZS_APPLICATION_INCLUDE_DIRECTORIES_PUBLIC}
	)
 
    TARGET_INCLUDE_DIRECTORIES(${ZS_APPLICATION_NAME} INTERFACE
        ${ZS_APPLICATION_INCLUDE_DIRECTORIES_INTERFACE}
    )

    TARGET_INCLUDE_DIRECTORIES(${ZS_APPLICATION_NAME} PRIVATE
        ${ZS_APPLICATION_INCLUDE_DIRECTORIES_PRIVATE}
    )

    TARGET_LINK_LIBRARIES(${ZS_APPLICATION_NAME} PUBLIC
        general
        "${ZS_APPLICATION_LINK_LIBRARIES_PUBLIC}"
        debug
        "${ZS_APPLICATION_LINK_LIBRARIES_PUBLIC_DEBUG}"
        optimized
        "${ZS_APPLICATION_LINK_LIBRARIES_PUBLIC_OPTIMIZED}"
    )
    
    TARGET_LINK_LIBRARIES(${ZS_APPLICATION_NAME} INTERFACE
        general
        "${ZS_APPLICATION_LINK_LIBRARIES_INTERFACE}"
        debug
        "${ZS_APPLICATION_LINK_LIBRARIES_INTERFACE_DEBUG}"
        optimized
        "${ZS_APPLICATION_LINK_LIBRARIES_INTERFACE_OPTIMIZED}"
    )
    
    TARGET_LINK_LIBRARIES(${ZS_APPLICATION_NAME} PRIVATE
        general
        "${ZS_APPLICATION_LINK_LIBRARIES_PRIVATE}"
        debug
        "${ZS_APPLICATION_LINK_LIBRARIES_PRIVATE_DEBUG}"
        optimized
        "${ZS_APPLICATION_LINK_LIBRARIES_PRIVATE_OPTIMIZED}"
    )
    
    TARGET_LINK_LIBRARIES(${ZS_APPLICATION_NAME} PUBLIC
        ${ZS_APPLICATION_USE_MODULES_PUBLIC}
    )
    
    TARGET_LINK_LIBRARIES(${ZS_APPLICATION_NAME} INTERFACE
        ${ZS_APPLICATION_USE_MODULES_INTERFACE}
    )
    
    TARGET_LINK_LIBRARIES(${ZS_APPLICATION_NAME} PRIVATE
        ${ZS_APPLICATION_USE_MODULES_PRIVATE}
    )
...
MACRO(ZS_SETUP_LIBRARY)
	IF(ZS_LIBRARY_MOC_SRCS)
        INCLUDE_DIRECTORIES(
            ${ZS_QT_ROOT}/include
            ${ZS_LIBRARY_MOC_INCLUDE_DIRECTORIES}
        )
    ...
    IF(NOT ZS_LIBRARY_CUSTOM_GROUP)
    ...
    TARGET_INCLUDE_DIRECTORIES(${ZS_LIBRARY_NAME} PUBLIC
        ${ZS_LIBRARY_INCLUDE_DIRECTORIES_PUBLIC}
    )
 
    TARGET_INCLUDE_DIRECTORIES(${ZS_LIBRARY_NAME} INTERFACE
        ${ZS_LIBRARY_INCLUDE_DIRECTORIES_INTERFACE}
    )

    TARGET_INCLUDE_DIRECTORIES(${ZS_LIBRARY_NAME} PRIVATE
        ${ZS_LIBRARY_INCLUDE_DIRECTORIES_PRIVATE}
    )

    TARGET_LINK_LIBRARIES(${ZS_LIBRARY_NAME} PUBLIC
        general
        "${ZS_LIBRARY_LINK_LIBRARIES_PUBLIC}"
        debug
        "${ZS_LIBRARY_LINK_LIBRARIES_PUBLIC_DEBUG}"
        optimized
        "${ZS_LIBRARY_LINK_LIBRARIES_PUBLIC_OPTIMIZED}"
    )
    
    TARGET_LINK_LIBRARIES(${ZS_LIBRARY_NAME} INTERFACE
        general
        "${ZS_LIBRARY_LINK_LIBRARIES_INTERFACE}"
        debug
        "${ZS_LIBRARY_LINK_LIBRARIES_INTERFACE_DEBUG}"
        optimized
        "${ZS_LIBRARY_LINK_LIBRARIES_INTERFACE_OPTIMIZED}"
    )
    
    TARGET_LINK_LIBRARIES(${ZS_LIBRARY_NAME} PRIVATE
        general
        "${ZS_LIBRARY_LINK_LIBRARIES_PRIVATE}"
        debug
        "${ZS_LIBRARY_LINK_LIBRARIES_PRIVATE_DEBUG}"
        optimized
        "${ZS_LIBRARY_LINK_LIBRARIES_PRIVATE_OPTIMIZED}"
    )
    
    TARGET_LINK_LIBRARIES(${ZS_LIBRARY_NAME} PUBLIC
        ${ZS_LIBRARY_USE_MODULES_PUBLIC}
    )
    
    TARGET_LINK_LIBRARIES(${ZS_LIBRARY_NAME} INTERFACE
        ${ZS_LIBRARY_USE_MODULES_INTERFACE}
    )
    
    TARGET_LINK_LIBRARIES(${ZS_LIBRARY_NAME} PRIVATE
        ${ZS_LIBRARY_USE_MODULES_PRIVATE}
    )
...
MACRO(ZS_SET_INCLUDE_CURRENT_DIR)
    SET(CMAKE_INCLUDE_CURRENT_DIR ON)
ENDMACRO(ZS_SET_INCLUDE_CURRENT_DIR)

MACRO(ZS_SET_GLOBAL_COMPILE_DEFINITIONS)
    SET(_ZS_GENERATOR "$<1:${ZS_GLOBAL_COMPILE_DEFINITIONS}>")
    LIST(LENGTH ZS_GLOBAL_CONFIGUATION_TYPES _ZS_LIST_LEN)
    FOREACH(i RANGE ${_ZS_LIST_LEN})
        IF(${i} EQUAL ${_ZS_LIST_LEN})
            BREAK()
        ENDIF()
        LIST(GET ZS_GLOBAL_CONFIGUATION_TYPES ${i} _ZS_CONF)
        SET(_ZS_ITEM "$<$<CONFIG:${_ZS_CONF}>:${ZS_GLOBAL_COMPILE_DEFINITIONS_${_ZS_CONF}}>")
        SET(_ZS_GENERATOR "${_ZS_GENERATOR};${_ZS_ITEM}")
    
    ENDFOREACH()
    
    SET_PROPERTY(DIRECTORY APPEND PROPERTY COMPILE_DEFINITIONS "${_ZS_GENERATOR}")
    
ENDMACRO(ZS_SET_GLOBAL_COMPILE_DEFINITIONS)


MACRO(ZS_SET_GLOBAL_COMPILE_OPTIONS)
    
    SET(_ZS_GENERATOR "$<1:${ZS_GLOBAL_COMPILE_OPTIONS}>")
    LIST(LENGTH ZS_GLOBAL_CONFIGUATION_TYPES _ZS_LIST_LEN)
    FOREACH(i RANGE ${_ZS_LIST_LEN})
        IF(${i} EQUAL ${_ZS_LIST_LEN})
            BREAK()
        ENDIF()
        LIST(GET ZS_GLOBAL_CONFIGUATION_TYPES ${i} _ZS_CONF)
        SET(_ZS_ITEM "$<$<CONFIG:${_ZS_CONF}>:${ZS_GLOBAL_COMPILE_OPTIONS_${_ZS_CONF}}>")
        SET(_ZS_GENERATOR "${_ZS_GENERATOR};${_ZS_ITEM}")
    
    ENDFOREACH()
    
    SET_PROPERTY(DIRECTORY APPEND PROPERTY COMPILE_OPTIONS "${_ZS_GENERATOR}")
    
ENDMACRO(ZS_SET_GLOBAL_COMPILE_OPTIONS)

MACRO(ZS_SET_GLOBAL_LINK_FLAGS)
# do nothing here
ENDMACRO(ZS_SET_GLOBAL_LINK_FLAGS)

MACRO(ZS_GET_BUILD_PLATFORMNAME __ZS_NAME)
    IF(ZS_WINDOWS)
    
        IF(ZS_WINDOWS_BUILD_32)
            SET(__ZS_BUILD Win32)
        ENDIF()
        
        IF(ZS_WINDOWS_BUILD_64)
            SET(__ZS_BUILD x64)
        ENDIF()
        ...
        SET(${__ZS_NAME} ${__ZS_BUILD}${__ZS_VC})
        
    ENDIF()
ENDMACRO(ZS_GET_BUILD_PLATFORMNAME __ZS_NAME)

MACRO(ZS_TODO)
    MESSAGE(WARNING "ZS_TODO!!!")
ENDMACRO(ZS_TODO)
